...
struct SQuad2 {
  ...
  SQuad2() = default;
  SQuad2(SQuad a, SQuad b) : a{a}, b{b} {}
};
...
struct SQuad4 {
  ...
  SQuad4() = default;
  SQuad4(SQuad2 a, SQuad2 b) : a{a.a}, b{a.b}, c{b.a}, d{b.b} {}
  SQuad4(SQuad a, SQuad b, SQuad c, SQuad d) : a{a}, b{b}, c{c}, d{d} {}
};

// Helper functions to translate BQuads and  SQuads
inline SQuad BQuadToSQuad(BQuad x) {
  return {static_cast<int16_t>(x[0]), static_cast<int16_t>(x[1]),
          static_cast<int16_t>(x[2]), static_cast<int16_t>(x[3])};
}

inline BQuad SQuadToBQuad(SQuad x) {
  return {static_cast<BYTE>(x[0]), static_cast<BYTE>(x[1]),
          static_cast<BYTE>(x[2]), static_cast<BYTE>(x[3])};
}
...
struct BQuad4 {
  ...
  BQuad4() = default;
  BQuad4(SQuad4 v)
      : a{SQuadToBQuad(v.a)}, b{SQuadToBQuad(v.b)}, c{SQuadToBQuad(v.c)},
        d{SQuadToBQuad(v.d)} {}
...
struct BQuad8 {
  ...
  BQuad8(SQuad4 a, SQuad4 b)
      : a{SQuadToBQuad(a.a)}, b{SQuadToBQuad(a.b)}, c{SQuadToBQuad(a.c)},
        d{SQuadToBQuad(a.d)}, e{SQuadToBQuad(b.a)}, f{SQuadToBQuad(b.b)},
        g{SQuadToBQuad(b.c)}, h{SQuadToBQuad(b.d)} {}
