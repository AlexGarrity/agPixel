...
RGB::RGB(const uint8_t *rgb) : _r{rgb[0]}, _g{rgb[1]}, _b{rgb[2]} {delete[] rgb;}

RGB::RGB(const uint8_t r, const uint8_t g, const uint8_t b) : _r{r}, _g{g}, _b{b} {}
...
RGBA::RGBA(const uint8_t *rgba) : RGB(rgba[0], rgba[1], rgba[2]), _a{rgba[3]} {delete[] rgba;}
