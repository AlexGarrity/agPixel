...
uint32_t fPixelArray::GetSize() const { return m_width * m_height; }
...
void PerformOperationInPlace(fPixelArray &a, fPixelArray &b,
                             FQuad2 f1(FQuad2, FQuad2),
                             FQuad f2(FQuad, FQuad)) {
...
void PerformOperationInPlace(fPixelArray &a, FQuad2 &qB,
                             FQuad2 f1(FQuad2, FQuad2),
                             FQuad f2(FQuad, FQuad)) {
  uint8_t remainder = a.GetSize() % 2;
  FQuad2 qA;
